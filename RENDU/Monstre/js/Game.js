export default class Game {
   ...
   async init(canvas) {
    ...
    drawMonstre(x, y) {
        ...
        // on déplace le système de coordonnées pour placer
        ...
        // Yeux
        this.drawCircleImmediat(30, 40, 10, "red");
        this.drawCircleImmediat(70, 40, 10, "red");
    
        // Bouche
        this.drawTriangle(this.ctx, 30, 60, 40, 60, 34, 70, "black");
        this.drawTriangle(this.ctx, 44, 60, 54, 60, 50, 70, "black");
        this.drawTriangle(this.ctx, 60, 60, 70, 60, 64, 70, "black");
    
        // Jambes
        this.ctx.fillStyle = "black";
        this.ctx.fillRect(30, 100, 10, 20);
        this.ctx.fillRect(60, 100, 10, 20);
    
        // Bras
        this.ctx.fillStyle = "black";
        this.ctx.fillRect(70, 50, 50, 10);
        this.ctx.fillRect(-20, 50, 40, 10);
    
        // Cornes
        this.ctx.fillStyle = "red";
        this.ctx.fillRect(10, -10, 10, 20);
        this.ctx.fillRect(74, -10, 10, 20);
